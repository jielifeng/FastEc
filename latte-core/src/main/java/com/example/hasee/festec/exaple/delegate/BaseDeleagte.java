...
public abstract class BaseDeleagte extends Fragment implements ISupportFragment {
    ...
    public abstract void onBinderView(@Nullable Bundle savedInstanceSate,View rootView);
